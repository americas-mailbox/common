...
class DeleteDateInWeeklyEventCest
{
    ...
    public function testDeleteFirstDayOfEvent(UnitTester $I)
    {
         ...
         * 2020-02-05 - 2020-03-18, active, next weekly 2020-02-05
         */
        ...
        $I->assertTrue($event2->getEndDate()->eq(new RapidCityTime('2020-03-18')));
        $I->assertTrue($event2->getNextWeekly()->eq(new RapidCityTime('2020-02-05')));
    ...
    public function testDeleteMidEvent(UnitTester $I)
    {
        $shippingEvent = $this->createShipment->weekly(
            new RapidCityTime('2020-01-29'),
            new RapidCityTime('2020-03-18'),
            new RapidCityTime('2020-02-05')
        );
        $this->deleteDateInRecurringEvent->delete($shippingEvent, new RapidCityTime('2020-02-19'));

        [$event1, $event2, $event3] = $this->saveShippingEvent->getSortedEvents();

        /**
         * 2020-01-29 - 2020-02-12, active, next weekly 2020-02-12
         * 2020-02-19 - 2020-02-19, not active, no next weekly
         * 2020-02-26 - 2020-03-18, active, next weekly 2020-02-26
         */
        $I->assertTrue($event1->getStartDate()->eq(new RapidCityTime('2020-01-29')));
        $I->assertTrue($event1->getEndDate()->eq(new RapidCityTime('2020-02-12')));
        $I->assertTrue($event1->getNextWeekly()->eq(new RapidCityTime('2020-02-05')));
        $I->assertTrue($event1->isActive());

        $I->assertTrue($event2->getStartDate()->eq(new RapidCityTime('2020-02-19')));
        $I->assertTrue($event2->getEndDate()->eq(new RapidCityTime('2020-02-19')));
        ...
        $I->assertTrue($event3->getEndDate()->eq(new RapidCityTime('2020-03-18')));
    ...
    public function testDeleteLastDateWithNextWeeklyPrior(UnitTester $I)
    {
        ...
        /**
         * 2020-01-15 - 2020-03-18, active, next weekly 2020-02-12
         * 2020-03-25 - 2020-03-25, not active, no next weekly
         */
        $I->assertTrue($event1->getStartDate()->eq(new RapidCityTime('2020-01-15')));
        $I->assertTrue($event1->getEndDate()->eq(new RapidCityTime('2020-03-18')));
    ...
    public function testDeleteLastDateWithNextWeeklyLastDate(UnitTester $I)
    {
        ...
        /**
         * 2020-01-15 - 2020-03-18, not active, no next weekly
         * 2020-03-25 - 2020-03-25, not active, no next weekly
         */
        $I->assertTrue($event1->getStartDate()->eq(new RapidCityTime('2020-01-15')));
        $I->assertTrue($event1->getEndDate()->eq(new RapidCityTime('2020-03-18')));
    ...
    {
        $startingEvent = $this->createShipment->weekly(
            new RapidCityTime('2020-01-29'),
            new RapidCityTime('2020-03-18'),
            new RapidCityTime('2020-02-12')
        );
        $this->deleteDateInRecurringEvent->delete($startingEvent, new RapidCityTime('2020-03-04'));
        ...
        /**
         * 2020-01-29 - 2020-02-26, active, next weekly 2020-02-12
         * 2020-03-04 - 2020-03-04, not active, no next weekly
         * 2020-03-11 - 2020-03-18, active, next weekly 2020-03-11
         */
        $I->assertTrue($event1->getStartDate()->eq(new RapidCityTime('2020-01-29')));
        ...
        $I->assertTrue($event2->getStartDate()->eq(new RapidCityTime('2020-03-04')));
        $I->assertTrue($event2->getEndDate()->eq(new RapidCityTime('2020-03-04')));
        $I->assertFalse($event2->isActive());
        $I->assertNull($event2->getNextWeekly());
        ...
        $events = $this->saveShippingEvent->getSortedEvents();
        $I->assertCount(5, $events);

        [$event1, $event2, $event3, $event4, $event5] = $events;

        /**
         * 2020-01-29 - 2020-02-05, not active, no next weekly
         * 2020-02-12 - 2020-02-12, not active, no next weekly
         * 2020-02-19 - 2020-02-26, active, next weekly 2020-02-19
         * 2020-03-04 - 2020-03-04, not active, no next weekly
         * 2020-03-11 - 2020-03-18, active, next weekly 2020-03-11
         */
        $I->assertTrue($event1->getStartDate()->eq(new RapidCityTime('2020-01-29')));
        ...
        $I->assertTrue($event3->getStartDate()->eq(new RapidCityTime('2020-02-19')));
        $I->assertTrue($event3->getEndDate()->eq(new RapidCityTime('2020-02-26')));
        $I->assertTrue($event3->isActive());
        $I->assertTrue($event3->getNextWeekly()->eq(new RapidCityTime('2020-02-19')));

        $I->assertTrue($event4->getStartDate()->eq(new RapidCityTime('2020-03-04')));
        $I->assertTrue($event4->getEndDate()->eq(new RapidCityTime('2020-03-04')));
        $I->assertFalse($event4->isActive());
        $I->assertNull($event4->getNextWeekly());

        $I->assertTrue($event5->getStartDate()->eq(new RapidCityTime('2020-03-11')));
        $I->assertTrue($event5->getEndDate()->eq(new RapidCityTime('2020-03-18')));
        $I->assertTrue($event5->isActive());
        $I->assertTrue($event5->getNextWeekly()->eq(new RapidCityTime('2020-03-11')));
    }
