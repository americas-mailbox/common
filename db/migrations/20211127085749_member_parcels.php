...
final class MemberParcels extends AbstractMigration
{
    ...
    public function change(): void
    {
        ...
        $this->table('member_parcels')
            ...
            ->addColumn('scanned_on', 'date', ['default' => null])
            ->addColumn('scanned_by_id', 'integer', ['default' => null])
            ->addColumn('shredded_on', 'date', ['default' => null])
            ->addColumn('shredded_by_id', 'integer', ['default' => null])
            ->addTimestamps()
            ->create();
    }
}
